...
File.open("update_all.sh", "w") do |file|
  ...
  file.write "cp /etc/awstats/index.html /var/www/awstats.jevon.org/index.html\n"

  domains.each do |domain|
    file.write "/usr/lib/cgi-bin/awstats.pl -config=#{domain} -update\n"
    file.write "/usr/share/awstats/tools/awstats_buildstaticpages.pl -config=#{domain} -dir=/var/www/awstats.jevon.org/ -awstatsprog=/usr/lib/cgi-bin/awstats.pl -showcorrupted\n"
    file.write "\n"
  end
